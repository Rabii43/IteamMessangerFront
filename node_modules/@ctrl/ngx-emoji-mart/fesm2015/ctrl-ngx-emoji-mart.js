...
import { EventEmitter, Input, Output, Component, ChangeDetectionStrategy, ɵɵdefineInjectable, Injectable, ChangeDetectorRef, ViewChild, ElementRef, ɵɵinject, ViewChildren, QueryList, NgModule } from '@angular/core';
...
EmojiFrequentlyService.ngInjectableDef = ɵɵdefineInjectable({ factory: function EmojiFrequentlyService_Factory() { return new EmojiFrequentlyService(); }, token: EmojiFrequentlyService, providedIn: "root" });
...
EmojiSearch.ngInjectableDef = ɵɵdefineInjectable({ factory: function EmojiSearch_Factory() { return new EmojiSearch(ɵɵinject(EmojiService)); }, token: EmojiSearch, providedIn: "root" });
