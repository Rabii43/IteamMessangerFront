...
export declare class EmojiService {
    ...
    emojiSpriteStyles(sheet: EmojiData['sheet'], set?: Emoji['set'], size?: Emoji['size'], sheetSize?: Emoji['sheetSize'], backgroundImageFn?: Emoji['backgroundImageFn'], sheetColumns?: number): {
        width: string;
        height: string;
        display: string;
