import { __assign, __spread, __values, __read, __decorate, __metadata } from 'tslib';
import { ɵɵdefineInjectable, Injectable, EventEmitter, Input, Output, Component, ChangeDetectionStrategy, NgModule } from '@angular/core';
...
var EmojiService = /** @class */ (function () {
    ...
    EmojiService.prototype.getData = function (emoji, skin, set) {
        ...
        if (hasSkinVariations && skin && skin > 1 && set) {
            ...
            if (!variationData.hidden || !variationData.hidden.includes(set)) {
                ...
                emojiData = __assign({}, emojiData, variationData);
            }
    ...
    EmojiService.ngInjectableDef = ɵɵdefineInjectable({ factory: function EmojiService_Factory() { return new EmojiService(); }, token: EmojiService, providedIn: "root" });
    ...
    EmojiComponent.prototype.ngOnChanges = function () {
        ...
        if (this.isNative && data.unified && data.native) {
            ...
            if (data.spriteUrl && this.sheetRows && this.sheetColumns) {
                this.style = __assign({}, this.style, { backgroundImage: "url(" + data.spriteUrl + ")", backgroundSize: 100 * this.sheetColumns + "% " + 100 *
                        this.sheetRows + "%", backgroundPosition: this.emojiService.getSpritePosition(data.sheet, this.sheetColumns) });
            }
            else {
                this.style = __assign({}, this.style, { backgroundImage: "url(" + data.imageUrl + ")", backgroundSize: 'contain' });
            }
        }
        else {
